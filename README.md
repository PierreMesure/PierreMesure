...
I'm currently leading a datalab at an agency under the Swedish ministry of finance 💰. Unfortunately, Swedish public sector is not a leader in publishing data nor open source code so I don't have so much to share here (yet! 🙋🏻‍♂️) but you can find our projects (in Swedish) at [datalabb.statskontoret.se](https://datalabb.statskontoret.se).
...
**g0v.se** downloads all the information on the Swedish government's main website every night at 3AM and makes it available as structured open data. It opens new possibilities for researchers, journalists, activists, government agencies and anyone who wants to build reliable services on government information from [regeringen.se](https://www.regeringen.se). Read more at [g0v.se](https://g0v.se).

Relevant repo:

- [g0vse](https://github.com/civictechsweden/g0vse)
...
- [Myndighetsdata](https://github.com/civictechsweden/myndighetsdata), merging 6 different government agency registries (*myndighetsregister*) to crossreference the data ([blog post](https://medium.com/civictechsweden/vem-har-koll-på-sveriges-myndigheter-dc8ca8e9dab7))
